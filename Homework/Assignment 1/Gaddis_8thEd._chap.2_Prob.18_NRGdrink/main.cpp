/* 
  ...
  Purpose:  Calculate the percent of customers drink more that 1 energy drink
 per week and what percentage prefer citrus.
 */
...
int main(int argc, char** argv) {
    ...
    float nmbmor,   //those that drink more than 1 drink a day
